...
import { ChevronDown, ChevronRight, Menu, Route } from "lucide-react";
import ThemeController from "@/Components/Header/ThemeToggler";
            ...
            <div className="flex-1 justify-between lg:hidden px-2">
              <h1 className="text-xl font-bold flex items-center">
                <span className="h-7 w-7 ">
                  <Route size={28} className="text-base-content" />
                </span>
                <span className="text-primary">Road</span>
                <span className="text-secondary">Fixer</span>
              </h1>
              <ThemeController />
            </div>
